-- Remove foreign key constraint from glass_order_items.order_number
...
INSERT INTO "glass_order_items_new"
SELECT "id", "glass_order_id", "order_number", "order_suffix", "position",
       "glass_type", "width_mm", "height_mm", "quantity", "created_at"
FROM "glass_order_items";
