...
export const ordersApi = {
  ...
  patch: (id: number, data: { valuePln?: string | null; valueEur?: string | null; deadline?: string | null; status?: string | null; invoiceNumber?: string | null; glassDeliveryDate?: string | null; documentAuthorUserId?: number | null }) =>
