...
import type { RemanentFormEntry, FinalizeMonthResponse, WarehouseDataResponse } from '@/types/warehouse';
...
export default function PvcRemanentPage() {
  ...
  // Pobierz wszystkie kolory (PVC warehouse colors endpoint)
  const { data: colorsResponse } = useQuery({
    queryKey: ['pvc-colors'],
    queryFn: () => fetchApi<{ colors: Color[] }>('/api/pvc-warehouse/colors'),
  });
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 pt-4">
        <Breadcrumb
          items={[
            { label: 'Magazyn PVC', href: '/magazyn/pvc', icon: <Warehouse className="h-4 w-4" /> },
                ...
                <CardContent>
                  {warehouseLoading ? (
                    ...
                    <EmptyState
                      ...
                      description="Nie znaleziono profili PVC dla tego koloru"
