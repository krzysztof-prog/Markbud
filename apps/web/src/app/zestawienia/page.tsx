...
export default function ZestawieniaPage() {
  ...
  const stats = {
    ...
    completedOrders: orders?.filter((o: any) => o.orderStatus === 'completed').length || 0,
    activeOrders: orders?.filter((o: any) => o.orderStatus === 'active').length || 0,
    totalValuePln: orders?.reduce((sum: number, o: any) => sum + (o.valuePln || 0), 0) || 0,
    totalValueEur: orders?.reduce((sum: number, o: any) => sum + (o.valueEur || 0), 0) || 0,
    totalWindows: orders?.reduce((sum: number, o: any) => sum + (o.totalWindows || 0), 0) || 0,
  };
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/zestawienia/zlecenia">
                <Button variant="outline" className="gap-2">
                  ...
                  SzczegóBowe zestawienie zleceD
                </Button>
              </Link>
            </div>
            {exportError && (
