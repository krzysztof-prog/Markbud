      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-medium block mb-1">
                Dlugosc (mm) <span className="text-red-600">*</span>
              </label>
              <Input
                type="number"
                value={data?.lengthMm || ''}
            ...
            <div>
              <label className="text-sm font-medium block mb-1">
                Szer. zaladunku (mm) <span className="text-red-600">*</span>
              </label>
              <Input
                type="number"
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        {error ? (
          ...
          <p className="py-4">
            Czy na pewno chcesz usunac <span className="font-semibold">{name}</span>? Tej operacji
            nie mozna cofnac.
          </p>
        )}
        <DialogFooter>
